...
class Classroom(list):
    ...
    def __init__(self, grade: int, letter: str, homeroom_teacher: Teacher = None, students=None):
        ...
        self._students = sorted(list(students), key=lambda student: (student.last_name, student.name))
    ...
    def read_csv(filename):
        with open(filename, mode='r', newline='', encoding='utf-8') as file:
            ...
            return Classroom(grade=grade, letter=letter, homeroom_teacher=homeroom_teacher, students=students)